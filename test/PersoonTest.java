...
class PersoonTest {
    ...
    public void testToStringGeenGames(){
        assertEquals(toStringTekstKoper0Games, koper.toString(), "toString() levert niet de juiste string op.");
    }

    @Test
    public void testToString1Game(){
        koper.koop(game1);
        assertEquals(toStringTekstKoperHeeftGame1 + "\n" + toStringTekstGame1, koper.toString(), "toString() levert niet de juiste string op.");
    }
    ...
    public void testToString2Games(){
        koper.koop(game1);
        koper.koop(game2);
        assertEquals(toStringTekstKoper2Games + "\n" + toStringTekstGame1 + "\n" + toStringTekstGame2, koper.toString(), "toString() levert niet de juiste string op.");
    }
    //endregion
    ...
    public void testGameListVerkoopVoorwaardenOK(){
        verkoper.koop(game2);
        boolean gelukt = verkoper.verkoop(game2, koper);
        assertEquals(toStringTekstVerkoper0Games, verkoper.toString(), "verkoop() moet gelukt zijn, maar levert een fout op in, waarschijnlijk, de lijst met Games (verkoper).");
        assertEquals(toStringTekstKoperHeeftGame2 + "\n" + toStringTekstGame2, koper.toString(), "verkoop() moet gelukt zijn, maar levert een fout op in, waarschijnlijk, de lijst met Games (koper).");
    }
    //endregion
}